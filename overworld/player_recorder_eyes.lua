...
--- @brief Calculate spherical eye transformation parameters
--- @brief Calculate spherical eye transformation parameters
--- @brief Calculate spherical eye transformation parameters
--- @param eye_side "left" | "right"
--- @brief Calculate spherical eye transformation parameters
--- @param eye_side "left" | "right" | "center"
function ow.PlayerRecorderEyes:_calculate_eye_transform(eye_side)
    ...
    return translate_x, translate_y, scale_x, scale_y, shear
end
