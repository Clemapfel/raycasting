...
--- @class ow.NebulaBackground
ow.NebulaBackground = meta.class("NebulaBackground", rt.Widget)
...
--- @brief
function ow.NebulaBackground:instantiate(scene)
    meta.assert(scene, ow.OverworldScene)
    self._scene = scene
end

--- @brief
function ow.NebulaBackground:realize()
...
--- @brief
function ow.NebulaBackground:size_allocate(x, y, width, height)
...
--- @brief
function ow.NebulaBackground:_draw()
...
--- @brief
function ow.NebulaBackground:draw()
...
--- @brief
function ow.NebulaBackground:draw_bloom()
    self._projection:bind()
...
function ow.NebulaBackground:notify_camera_changed(camera)
...
function ow.NebulaBackground:_get_3d_bounds()
    local aspect = self._bounds.width / self._bounds.height
    local fov = math.pi * self._projection:get_fov()
    local tan_half = math.tan(0.5 * fov)
...
function ow.NebulaBackground:_get_scale_factor()
    local aspect = self._bounds.width / self._bounds.height
...
--- @brief
function ow.NebulaBackground:update(delta, override)
...
function ow.NebulaBackground:_init_cube_particle()
...
function ow.NebulaBackground:_init_tetrahedron_particle()
    local mesh_data = {}
    local vertex_index = 1
...
function ow.NebulaBackground:_init_octahedron_particle()
    local mesh_data = {}
    local vertex_index = 1
...
function ow.NebulaBackground:_init_icosahedron_particle()
    local mesh_data = {}
    local vertex_index = 1
...
function ow.NebulaBackground:_init_dodecahedron_particle()
    local mesh_data = {}
    local vertex_index = 1
...
function ow.NebulaBackground:_init_sphere_particle(n_rings, n_segments_per_ring)
...
function ow.NebulaBackground:_init_glow_particle()
...
function ow.NebulaBackground:_init_cuboid_particle()
    local mesh_data = {}
    local indices = {}
...
--- @brief
function ow.NebulaBackground:_init_room_mesh()
...
--- @brief
function ow.NebulaBackground:_init_front_wall_mesh()
    local mesh_data = {}
    local function add_vertex(x, y, z, u, v)
        table.insert(mesh_data, {
            x, y, z, u, v, 1, 1, 1, 1
