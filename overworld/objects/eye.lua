...
function ow.Eye:draw()
    ...
    _highlight_shader:send("elapsed", rt.SceneManager:get_elapsed() + meta.hash(self))
    _highlight_shader:send("direction", { self._iris_x / self._radius, self._iris_y / self._radius, 2 })
